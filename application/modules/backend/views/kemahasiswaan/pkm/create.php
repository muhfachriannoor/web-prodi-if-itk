...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Tambah Program Kreativitas Mahasiswa
      <!-- <small>Preview</small> -->
    </h1>
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Program Kreativitas Mahasiswa</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/kemahasiswaan/pkm/create/up');?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_pkm" class="form-control" required="required" placeholder="Isi Nama Program..." value="<?= set_value('nama_pkm');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Jenis</label>
                  <input type="text" name="jenis_pkm" class="form-control" required="required" placeholder="Isi Jenis..." value="<?= set_value('jenis_pkm');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Tahun</label>
                  <input type="number" name="tahun_pkm" class="form-control" required="required" placeholder="20xx" value="<?= set_value('tahun_pkm');?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Ketua</label>
                  <input type="text" name="ketua_pkm" class="form-control" required="required" placeholder="Isi Ketua..." value="<?= set_value('ketua_pkm');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
