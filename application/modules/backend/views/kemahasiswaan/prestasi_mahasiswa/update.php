...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Prestasi Mahasiswa</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/kemahasiswaan/prestasi_mahasiswa/update/down/'.$datanya->idPrestasi);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_prestasi" class="form-control" required="required" placeholder="Isi Nama Prestasi..." value="<?= $datanya->nama_prestasi;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" name="date_prestasi" class="form-control pull-right" id="datepicker" data-date-format="yyyy-mm-dd" placeholder="0000-00-00" required="required" value="<?= $datanya->date_prestasi;?>">
                  </div>
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Tempat</label>
                  <input type="text" name="tempat_prestasi" class="form-control" required="required" placeholder="Isi Tempat..." value="<?= $datanya->tempat_prestasi;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="peringkat_prestasi" class="form-control" required="required" placeholder="Isi Peringkat..." value="<?= $datanya->peringkat_prestasi;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
