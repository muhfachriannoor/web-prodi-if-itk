...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Organisasi Kemahasiswaan</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/kemahasiswaan/ormawa/create/up');?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_ormas" class="form-control" required="required" placeholder="Isi Nama Organisasi Kemahasiswaan..." value="<?= set_value('nama_ormas');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
