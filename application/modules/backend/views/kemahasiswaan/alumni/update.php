...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Alumni</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/kemahasiswaan/alumni/update/down/'.$datanya->nim_alumni);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="number" name="nim_alumni" class="form-control" required="required" placeholder="Isi NIM Alumni..." value="<?= $datanya->nim_alumni;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_alumni" class="form-control" required="required" placeholder="Isi Nama Alumni..." value="<?= $datanya->nama_alumni  ;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="number" name="tahunmasuk_alumni" class="form-control" required="required" placeholder="20xx" value="<?= $datanya->tahunmasuk_alumni;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="number" name="tahunlulus_alumni" class="form-control" required="required" placeholder="20xx" value="<?= $datanya->tahunlulus_alumni;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Jejak</label>
                  <input type="text" name="jejak" class="form-control" required="required" placeholder="Isi Jejak..." value="<?= $datanya->jejak;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
