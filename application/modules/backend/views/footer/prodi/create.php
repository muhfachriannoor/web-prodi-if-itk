...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Link Prodi</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/footer/prodi/create/up');?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="number" name="nomor_prodi" class="form-control" required="required" placeholder="Isi Nomor Prodi..." value="<?= set_value('nomor_prodi');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_prodi" class="form-control" required="required" placeholder="Isi Nama Prodi..." value="<?= set_value('nama_prodi');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Link</label>
                  <input type="text" name="url_prodi" class="form-control" required="required" placeholder="Isi Link..." value="<?= set_value('url_prodi');?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
