...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/submenu/update/down/'.$datanya->idBantu);?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <select name="idMenu" class="form-control" required="required">
                    ...
                    ?>
                    <?php if($menu->nameMenu != 'Beranda'): ?>
                    <option value="<?= $menu->idMenu;?>" <?= ($datanya->idMenu == $menu->idMenu) ? 'selected="selected"' : '';?>><?= $menu->nameMenu;?></option>
                    <?php endif; ?>
                    <?php endforeach; ?>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nameSubMenu" class="form-control" required="required" placeholder="Isi Nama Sub Menu..." value="<?= $datanya->nameSubMenu;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
            ...
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="kolom1" rows="20" cols="100" required="required" placeholder="Isi Kontent...."><?= $datanya->kolom1;?></textarea>
        ...
        <div class="box-footer text-center">
          <input type="hidden" name="old_url" value="<?= $datanya->url_bantu;?>">
