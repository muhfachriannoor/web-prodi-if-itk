...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/kontak/update/down/'.$datanya->id_kontak);?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Email</label>
                  <input type="email" name="email" class="form-control" required="required" placeholder="email@mail.com" value="<?= $datanya->email;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Telpon</label>
                  <input type="text" name="telpon" class="form-control" required="required" placeholder="0541xxx" value="<?= $datanya->telpon;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="gmap" class="form-control" required="required" placeholder="Isi Link Google Maps..." value="<?= $datanya->gmap;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="facebook" class="form-control" placeholder="Isi Link Facebook..." value="<?= $datanya->facebook;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="twitter" class="form-control" placeholder="Isi Link Twitter..." value="<?= $datanya->twitter;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="youtube" class="form-control" placeholder="Isi Link Youtube..." value="<?= $datanya->youtube;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="instagram" class="form-control" placeholder="Isi Link Instagram..." value="<?= $datanya->instagram;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Alamat</label>
                  <textarea name="alamat" class="form-control" required="required" placeholder="Isi Alamat..." rows="10"><?= $datanya->alamat;?></textarea>
                </div>
              <?php endif; ?>
            </div>
          </div>
