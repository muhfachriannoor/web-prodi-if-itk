...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Ubah Visi, Misi, Tujuan, dan Moto
      <!-- <small>Preview</small> -->
    </h1>
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Visi, Misi, Tujuan, dan Moto</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/profile/visimisi/update/down/'.$datanya->id_visimisi);?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="text_visi" rows="10" cols="80" required="required" placeholder="Isi Text Visi...."><?= $datanya->visi_text;?></textarea>
                </div>
              <?php endif; ?>
            </div>
          </div>
            ...
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <textarea id="editor2" name="text_misi" rows="10" cols="80" required="required" placeholder="Isi Text Misi...."><?= $datanya->misi_text;?></textarea>
                </div>
              <?php endif; ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea id="editor3" name="text_tujuan" rows="10" cols="80" required="required" placeholder="Isi Text Tujuan...."><?= $datanya->tujuan_text;?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea id="editor4" name="text_motto" rows="10" cols="80" required="required" placeholder="Isi Text Motto...."><?= $datanya->motto_text;?></textarea>
              </div>
            </div>
          </div>
        </div>
