...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Kerjasama</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/profile/kerjasama/update/down/'.$datanya->idKerjasama);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_kerjasama" class="form-control" required="required" placeholder="Isi Nama Kerjasama..." value="<?= $datanya->nama_kerjasama;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="deskripsi_kerjasama" rows="10" cols="80" required="required" placeholder="Isi Deskripsi...."><?= $datanya->deskripsi_kerjasama;?></textarea>
                </div>
              <?php endif; ?>
            </div>
          </div>
