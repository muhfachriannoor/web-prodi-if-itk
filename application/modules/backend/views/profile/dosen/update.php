...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Ubah Dosen dan Tenaga Pendidik
      <!-- <small>Preview</small> -->
    </h1>
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Dosen dan Tenaga Pendidik</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/profile/dosen/update/down/'.$datanya->idDosen);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>NIP</label>
                  <input type="text" name="nip_dosen" class="form-control" required="required" placeholder="Isi NIP..." value="<?= $datanya->nip_dosen;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Nama</label>
                  <input type="text" name="nama_dosen" class="form-control" required="required" placeholder="Isi Nama..." value="<?= $datanya->nama_dosen;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Jabatan</label>
                  <input type="text" name="jabatan_dosen" class="form-control" required="required" placeholder="Isi Jabatan..." value="<?= $datanya->jabatan_dosen;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
            ...
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="gschoolar" class="form-control" placeholder="Isi Google Scholar..." value="<?= $datanya->gschoolar;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="linkedin" class="form-control" placeholder="Isi LinkedIn..." value="<?= $datanya->linkedin;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Scopus</label>
                  <input type="text" name="scopus" class="form-control" placeholder="Isi Scopus..." value="<?= $datanya->scopus;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Email</label>
                  <input type="email" name="email_dosen" class="form-control" required="required" placeholder="dosen@mail.com" value="<?= $datanya->email_dosen;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <textarea name="text_dosen" class="form-control" placeholder="Isi Sekilas Dosen..." rows="5"><?= $datanya->text_dosen;?></textarea>
                </div>
              <?php endif; ?>
            </div>
          </div>
