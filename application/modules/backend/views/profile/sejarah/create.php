...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/profile/sejarah/create/up');?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="text_sejarah" rows="20" cols="100" required="required" placeholder="Isi Text Sejarah...."><?= set_value('text_sejarah');?></textarea>
                </div>
              <?php endif; ?>
            </div>
          </div>
