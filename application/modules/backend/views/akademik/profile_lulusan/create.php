...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Profile Lulusan</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/akademik/profile_lulusan/create/up');?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_profil" class="form-control" required="required" placeholder="Isi Nama Profil..." value="<?= set_value('nama_profil');?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
