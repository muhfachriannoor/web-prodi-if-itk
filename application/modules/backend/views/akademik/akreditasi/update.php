...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Akreditasi</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/akademik/akreditasi/update/down/'.$datanya->id_akreditasi);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-12">
              <?php if($error == TRUE OR form_error('akreditasi_file') == TRUE): ?>
                <div class="form-group has-warning">
                  ...
                  <input type="file" name="akreditasi_file" class="form-control">
                </div>
              <?php else: ?>
            ...
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="akreditasi_text" rows="10" cols="80" required="required" placeholder="Isi Deskripsi Akreditasi...."><?= $datanya->akreditasi_text;?></textarea>
                </div>
              <?php endif; ?>
            </div>
          </div>
