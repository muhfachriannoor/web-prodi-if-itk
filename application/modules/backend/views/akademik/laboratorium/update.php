...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Laboratorium</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/akademik/laboratorium/update/down/'.$datanya->id_laboratorium);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_laboratorium" class="form-control" required="required" placeholder="Isi Nama Laboratorium..." value="<?= $datanya->nama_laboratorium;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="deskripsi_laboratorium" rows="10" cols="80" required="required" placeholder="Isi Deskripsi...."><?= $datanya->laboratorium_text;?></textarea>
                </div>
              <?php endif; ?>
            </div>
          </div>
