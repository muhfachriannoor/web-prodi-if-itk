...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/akademik/kurikulum/create/up');?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <select name="jenis_kurikulum" class="form-control" required="required">
                    <option value="none" hidden="hidden">-- PILIH JENIS KURIKULUM --</option>
                    <option value="Mata Kuliah Semester" <?= (set_value('jenis_kurikulum') == 'Mata Kuliah Semester') ? 'selected="selected"' : '' ;?>>Mata Kuliah Semester</option>
                    <option value="Mata Kuliah Keminatan" <?= (set_value('jenis_kurikulum') == 'Mata Kuliah Keminatan') ? 'selected="selected"' : '' ;?>>Mata Kuliah Keminatan</option>
                  </select>
                </div>
              <?php endif; ?>
            </div>
