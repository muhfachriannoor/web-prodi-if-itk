...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah File Kalender Akademik</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/akademik/kalender_akademik_file/update/down/'.$datanya->id_kalender);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="tahun_ajaran" class="form-control" required="required" placeholder="20xx/20xx" value="<?= $datanya->tahunajar_kalender ?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
