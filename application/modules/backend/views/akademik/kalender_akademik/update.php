...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Kalender Akademik</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/akademik/kalender_akademik/update/down/'.$datanya->id_kalender);?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Judul</label>
                  <input type="text" name="judul_kalender" class="form-control" required="required" placeholder="Isi Judul..." value="<?= $datanya->judul_kalender;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" name="start_kalender" class="form-control pull-right" id="datepicker" data-date-format="yyyy-mm-dd" placeholder="0000-00-00" required="required" value="<?= $datanya->start_kalender;?>">
                  </div>
                </div>
              <?php endif; ?>
            </div>
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" name="end_kalender" class="form-control pull-right" id="datepicker2" data-date-format="yyyy-mm-dd" placeholder="0000-00-00" required="required" value="<?= $datanya->end_kalender;?>">
                  </div>
                </div>
              <?php endif; ?>
            </div>
