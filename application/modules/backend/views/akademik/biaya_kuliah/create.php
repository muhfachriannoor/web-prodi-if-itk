...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Biaya Kuliah</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/akademik/biaya_kuliah/create/up');?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <select name="jalur_biaya" class="form-control" required="required">
                    <option value="none" hidden="hidden">-- PILIH JALUR BIAYA --</option>
                    <option value="SBMPTN/SNMPTN" <?= (set_value('jalur_biaya') == 'SBMPTN/SNMPTN') ? 'selected="selected"' : '';?>>SBMPTN/SNMPTN</option>
                    <option value="Mandiri" <?= (set_value('jalur_biaya') == 'Mandiri') ? 'selected="selected"' : '';?>>Mandiri</option>
                  </select>
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="kategori_biaya" class="form-control" placeholder="Isi Kategori UKT..." value="<?= set_value('kategori_biaya');?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="number" name="tarif_biaya" class="form-control" required="required" placeholder="0000" value="<?= set_value('tarif_biaya');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="tarif_spi_biaya" class="form-control" placeholder="0000" value="<?= set_value('tarif_spi_biaya');?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
