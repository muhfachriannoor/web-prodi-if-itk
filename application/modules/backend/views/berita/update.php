...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/berita/update/down/'.$datanya->idBerita);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="judul_berita" class="form-control" required="required" placeholder="Isi Judul Berita..." value="<?= $datanya->judul_berita;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <select name="id_kategori" class="form-control" required="required">
                    ...
                    <?php
                      ...
                      foreach($kategori->result() as $no => $kategori):
                    ?>
                    <option value="<?= $kategori->idKategori;?>" <?= ($datanya->idKategori == $kategori->idKategori) ? 'selected="selected"' : '';?>><?= $kategori->nama_kategori;?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              <?php endif; ?>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" name="video_berita" class="form-control" placeholder="https://www.youtube.com/embed/ZpHg0ABxm3s" value="<?= $datanya->video_berita;?>">
              </div>
            </div>
            <div class="col-md-3">
