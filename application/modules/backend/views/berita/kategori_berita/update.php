...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Kategori Berita</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/berita/kategori_berita/update/down/'.$datanya->idKategori);?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_kategori" class="form-control" required="required" placeholder="Isi Nama Kategori..." value="<?= $datanya->nama_kategori;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
