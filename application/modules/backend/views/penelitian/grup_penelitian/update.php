...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Grup Penelitian</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/penelitian/grup_penelitian/update/down/'.$datanya->idGrupPenelitian);?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_grup" class="form-control" required="required" placeholder="Isi Nama Grup Penelitian..." value="<?= $datanya->nama_grup;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
