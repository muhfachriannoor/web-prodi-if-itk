...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Hasil Penelitian</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/penelitian/hasil_penelitian/create/up');?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="judul_penelitian" class="form-control" required="required" placeholder="Isi Judul Penelitian..." value="<?= set_value('judul_penelitian');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Tahun</label>
                  <input type="number" name="tahun_penelitian" class="form-control" required="required" placeholder="20xx" value="<?= set_value('tahun_penelitian');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="sumberdana_penelitian" class="form-control" required="required" placeholder="Isi Sumber Dana..." value="<?= set_value('sumberdana_penelitian');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
