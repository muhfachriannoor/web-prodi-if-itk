...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Hasil Pengabdian</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/penelitian/hasil_pengabdian/create/up');?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="judul_pengabdian" class="form-control" required="required" placeholder="Isi Judul Pengabdian..." value="<?= set_value('judul_pengabdian');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Tahun</label>
                  <input type="number" name="tahun_pengabdian" class="form-control" required="required" placeholder="20xx" value="<?= set_value('tahun_pengabdian');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="sumberdana_pengabdian" class="form-control" required="required" placeholder="Isi Sumber Dana..." value="<?= set_value('sumberdana_pengabdian');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
