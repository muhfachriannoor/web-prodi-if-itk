            ...
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_user" class="form-control" required="required" placeholder="Isi Nama Lengkap..." value="<?= set_value('nama_user');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="username" class="form-control" required="required" placeholder="Isi Username..." value="<?= set_value('username')?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Email</label>
                  <input type="email" name="email" class="form-control" required="required" placeholder="email@gmail.com" value="<?= set_value('email');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <select name="akses" class="form-control" required="required">
                    <option value="none" hidden="hidden">-- PILIH LEVEL AKUN --</option>
                    <option value="1" <?= (set_value('akses') == '1') ? 'selected="selected"' : '';?>>Administrator</option>
                    <option value="2" <?= (set_value('akses') == '2') ? 'selected="selected"' : '';?>>Dosen</option>
                  </select>
                </div>
              <?php endif; ?>
            </div>
