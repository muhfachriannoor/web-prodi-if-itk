...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Bidang Minat</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/beranda/bidangminat/update/down/'.$datanya->idBidangminat);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_bidangminat" class="form-control" required="required" placeholder="Isi Nama Bidang Minat..." value="<?= $datanya->nama_bidangminat;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
              <?php if($error == TRUE OR form_error('foto_bidangminat') == TRUE): ?>
                <div class="form-group has-warning">
                  ...
                  <input type="file" name="foto_bidangminat" class="form-control">
                </div>
              <?php else: ?>
                <div class="form-group">
