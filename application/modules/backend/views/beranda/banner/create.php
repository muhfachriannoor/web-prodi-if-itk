            ...
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Judul</label>
                  <input type="text" name="judul_banner" class="form-control" required="required" placeholder="Isi Judul..." value="<?= set_value('judul_banner');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="url" class="form-control" placeholder="https://www.google.com" value="<?= set_value('url');?>">
              </div>
            </div>
            <div class="col-md-4">
