...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/beranda/pengumuman/update/down/'.$datanya->idPengumuman);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Judul</label>
                  <input type="text" name="judul_pengumuman" class="form-control" required="required" placeholder="Isi Judul..." value="<?= $datanya->judul_pengumuman;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
