...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/beranda/beasiswa/update/down/'.$datanya->idBeasiswa);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="nama_beasiswa" class="form-control" required="required" placeholder="Isi Nama Beasiswa..." value="<?= $datanya->nama_beasiswa;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
