...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Overview Prodi</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/beranda/overview/create/up');?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="jurusan" class="form-control" required="required" placeholder="Isi Nama Jurusan..." value="<?= set_value('jurusan');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="akreditasi" class="form-control" required="required" placeholder="Isi Akreditasi..." value="<?= set_value('akreditasi');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="number" name="jumlah_mahasiswa" class="form-control" required="required" placeholder="Isi Jumlah Mahasiswa..." value="<?= set_value('jumlah_mahasiswa');?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="url_youtube" class="form-control" placeholder="https://www.youtube.com/embed/ZpHg0ABxm3s" value="<?= set_value('url_youtube');?>">
              </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <?php if($error == TRUE OR form_error('foto_overview') == TRUE): ?>
                <div class="form-group has-warning">
                  ...
                  <input type="file" name="foto_overview" class="form-control" required="required">
                </div>
              <?php else: ?>
                <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Text</label>
                  <textarea name="text_overview" class="form-control" required="required" placeholder="Isi Text..." rows="5"><?= set_value('text_overview');?></textarea>
                </div>
              <?php endif; ?>
            </div>
          </div>
