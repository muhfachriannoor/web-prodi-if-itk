<?php
  $tgl_kegiatan = $datanya->tgl_kegiatan;

  $hari = substr($tgl_kegiatan, 8, 2);
  $bulan = substr($tgl_kegiatan, 5, 2);
  $tahun = substr($tgl_kegiatan, 0, 4);
  $jam = substr($tgl_kegiatan, 11, 2);
  $menit = substr($tgl_kegiatan, 14, 2);
  $detik = substr($tgl_kegiatan, 17, 2);
...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/beranda/kegiatan/update/down/'.$datanya->idKegiatan);?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Judul</label>
                  <input type="text" name="judul_kegiatan" class="form-control" required="required" placeholder="Isi Judul..." value="<?= $datanya->judul_kegiatan;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Jenis</label>
                  <input type="text" name="jenis_kegiatan" class="form-control" required="required" placeholder="Isi Jenis..." value="<?= $datanya->jenis_kegiatan;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <input type="text" name="penyelenggara_kegiatan" class="form-control" required="required" placeholder="Isi Penyelenggara..." value="<?= $datanya->penyelenggara_kegiatan;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-3">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Materi</label>
                  <input type="text" name="materi_kegiatan" class="form-control" required="required" placeholder="Isi Materi..." value="<?= $datanya->materi_kegiatan;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
          <div class="row">
             <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Lokasi</label>
                  <input type="text" name="lokasi_kegiatan" class="form-control" required="required" placeholder="Isi Lokasi..." value="<?= $datanya->lokasi_kegiatan;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Ruang</label>
                  <input type="text" name="ruang_kegiatan" class="form-control" required="required" placeholder="Isi Ruang..." value="<?= $datanya->ruang_kegiatan;?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Peserta</label>
                  <input type="text" name="peserta_kegiatan" class="form-control" required="required" placeholder="Isi Peserta..." value="<?= $datanya->peserta_kegiatan;?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" name="tanggal" class="form-control pull-right" id="datepicker" data-date-format="yyyy-mm-dd" placeholder="0000-00-00" required="required" value="<?= $tanggal;?>">
                  </div>
                </div>
              <?php endif; ?>
            </div>
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="time" name="waktu" class="form-control" data-date-format="h:i:s" placeholder="00:00" required="required" value="<?= $waktu;?>">
                  </div>
                </div>
              <?php endif; ?>
            </div>
