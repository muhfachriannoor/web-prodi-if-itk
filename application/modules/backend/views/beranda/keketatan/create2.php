...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah UTBK</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/beranda/keketatan/create/up2');?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Nilai</label>
                  <input type="number" step="any" name="nilai" class="form-control" required="required" placeholder="000" value="<?= set_value('nilai');?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
