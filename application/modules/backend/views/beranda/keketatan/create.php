...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Keketatan</li>
    </ol>
  </section>
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/beranda/keketatan/create/up');?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  ...
                  <select name="jalur_keketatan" class="form-control" required="required">
                    <option value="none" hidden="hidden">-- PILIH JALUR --</option>
                    <option value="SBMPTN" <?= (set_value('jalur_keketatan') == 'SBMPTN') ? 'selected="selected"' : '';?>>SBMPTN</option>
                    <option value="SNMPTN" <?= (set_value('jalur_keketatan') == 'SNMPTN') ? 'selected="selected"' : '';?>>SNMPTN</option>
                    <option value="Mandiri" <?= (set_value('jalur_keketatan') == 'Mandiri') ? 'selected="selected"' : '';?>>Mandiri</option>
                  </select>
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Tahun</label>
                  <input type="number" name="tahun_keketatan" class="form-control" required="required" placeholder="Isi Tahun..." value="<?= set_value('tahun_keketatan');?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Kuota</label>
                  <input type="number" name="kuota_keketatan" class="form-control" required="required" placeholder="000" value="<?= set_value('kuota_keketatan');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-6">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Peminat</label>
                  <input type="number" name="peminat_keketatan" class="form-control" required="required" placeholder="000" value="<?= set_value('peminat_keketatan');?>">
                </div>
              <?php endif; ?>
            </div>
          </div> 
