...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="<?= site_url('backend/beranda/testimoni/create/up');?>" method="post" enctype="multipart/form-data">
        <?php if($error == TRUE): ?>
            ...
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Nama</label>
                  <input type="text" name="nama" class="form-control" required="required" placeholder="Isi Nama..." value="<?= set_value('nama');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              ...
              <?php else: ?>
                <div class="form-group">
                  <label>Posisi</label>
                  <input type="text" name="posisi" class="form-control" required="required" placeholder="Isi Posisi..." value="<?= set_value('posisi');?>">
                </div>
              <?php endif; ?>
            </div>
            <div class="col-md-4">
              <?php if($error == TRUE OR form_error('foto_testimoni') == TRUE): ?>
                <div class="form-group has-warning">
                  ...
                  <input type="file" name="foto_testimoni" class="form-control" required="required">
                </div>
              <?php else: ?>
                <div class="form-group">
